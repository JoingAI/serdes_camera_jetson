# FG12-4CH/FG24-4CH FZCAM JetPack 6.x (R36.5.x) SOP (English)

Directory: JetPack_6.2.2_R36.5_4CH_YUV_Cameras

## 1. Objectives

- Complete firmware/application upgrade on Jetson Orin NX/Nano + FG12-4CH/FG24-4CH SerDes kit.
