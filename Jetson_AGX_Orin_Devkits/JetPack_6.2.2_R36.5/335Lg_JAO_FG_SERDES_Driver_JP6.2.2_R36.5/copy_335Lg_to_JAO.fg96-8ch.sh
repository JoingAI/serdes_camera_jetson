...
#8x335Lg
sudo cp tegra234-camera-g300-fg96-8ch-overlay.dtbo /boot/
...
echo "1) CAM0&1 仅连接 335Lg 相机, CAM2~7连接RGB"
echo "2) CAM0~3 仅连接 335Lg 相机, CAM4~7连接RGB"
...
case $choice in
	...
	sudo /opt/nvidia/jetson-io/config-by-hardware.py -n 2="Jetson Camera FG96_8CH_DPHY_8xG335Lg"
        ;;
    1)
        # 335Lg + RGB Sensor need 2x335Lg(CAM0&CAM1) + 6xRGB_YUV
	    sudo /opt/nvidia/jetson-io/config-by-hardware.py -n 2="Jetson Camera FG96_8CH_2x335Lg_6xRGB"
        ;;
    2)
	    # 335Lg + RGB Sensor need 4x335Lg(CAM0&CAM1) + 4xRGB_YUV
