...
## copy max96712.ko file ##
max96712_dir=/lib/modules/$(uname -r)/updates/drivers/media/i2c/
if [ ! -f $max96712_dir/max96712.ko.orig ];then
    echo "bakckup max96712.ko"
    sudo cp $max96712_dir/max96712.ko $max96712_dir/max96712.ko.orig
fi
sudo cp max96712.ko $max96712_dir
sudo cp max96717.ko $max96712_dir
...
# 2xD4XX
sudo cp tegra234-camera-d4xx-overlay-fg12-12ch-cams-0-4.dtbo  /boot/
sudo /opt/nvidia/jetson-io/config-by-hardware.py -n 2="Jetson Camera FG12_12CH D4XX-CAM0-4"
